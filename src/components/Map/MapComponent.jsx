...
const customIcon = new L.Icon({
  iconUrl: 'map.svg',  // Ajusta la ruta
  iconSize: [40, 50],  // Ajusta el tamaño 
...
export default function MapContainerComponent() {
  ...
  return (
    <MapContainer center={position} zoom={17} scrollWheelZoom={false} className="md:w-[50%] md:h-[80%] w-[90%] h-[70%]  rounded-2xl shadow-2xl shadow-orange-900 ">
      <TileLayer
